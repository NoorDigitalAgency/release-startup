...
async function run(): Promise<void> {
  ...
  try {
    ...
    if (stage === 'alpha') {
      ...
      const body = `A pull request generated by [dawn](https://github.com/NoorDigitalAgency/dawn "Dawn, multistage releases semantic versioning action") action for **${hotfix ? 'hotfix' : stage}** release version **${version}**.`;
